...
public class NotifBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(action.equals(context.getPackageName()+"co.ronash.pushe.NOTIF_CLICKED")){
            Log.i("Pushe", "Broadcast co.ronash.pushe.NOTIF_CLICKED received");
            //add your logic here
        }
        else if(action.equals(context.getPackageName()+"co.ronash.pushe.NOTIF_DISMISSED")){
            Log.i("Pushe", "Broadcast co.ronash.pushe.NOTIF_DISMISSED received");
            //add your logic here
        }
        else if(action.equals(context.getPackageName()+"co.ronash.pushe.NOTIF_BTN_CLICKED")){
